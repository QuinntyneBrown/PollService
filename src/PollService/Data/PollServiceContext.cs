...
{
    public interface IPollServiceContext
    {
        ...
        DbSet<PollResult> PollResults { get; set; }
        DbSet<Poll> Polls { get; set; }
        Task<int> SaveChangesAsync();
    }

    public class PollServiceContext: DbContext, IPollServiceContext
    {
        public PollServiceContext()
            :base("PollServiceContext")
        {
